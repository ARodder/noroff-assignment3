...
public class CharacterController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Success", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = MovieCharacterDTO.class))
                        }),
         ...
         * 
         * @return A Collection of Data Transfer Objects representing the retrieved
         *         Characters
         */
        @GetMapping
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Success", content = {
                                        @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = MovieCharacterDTO.class)))
                        })
        })
         ...
         * 
         * @param entity: A Data Transfer Object representing the Character entity to be
         *                added
         ...
         * @param id:     Integer identifier representing the unique Character entry to
         *                be updated
         ...
         * 
         * @param entity: A Data Transfer Object representing the Character to be
         *                deleted
         * @param id:     Integer identifier representing the unique Character to be
         *                deleted
